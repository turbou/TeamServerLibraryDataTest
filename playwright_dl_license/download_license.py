...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("link", name="License").click()
    ...
    with page.expect_download() as download_lic_info:
        page.get_by_role("row", name=os.environ['FILE_NAME']).get_by_role("button", name="Download").click()
    download_lic = download_lic_info.value
    download_lic.save_as('/work/' + download_lic.suggested_filename)
